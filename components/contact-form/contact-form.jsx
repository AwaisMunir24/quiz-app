        ...
        <div className='container'>
           ...
           <div className='col-lg-7'>
                  <div>
                      ...
                      <div>
                        <p className='udpate_heading'>Contact us to receive new updates about Test Islam</p>
                        <div>
                  ...
                  <div className='col-lg-5'>
                    <div className="form_wrapper text-center">
                      ...
                      <textarea rows={5} placeholder='Enter Your Message' className='form-control'></textarea>
