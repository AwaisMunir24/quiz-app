        ...
        <div className='container-fluid'>
            <div className='row '>
                    ...
                    <div className='col-lg-4 '>
                      <Image src={'/images/footerlogo.png'} alt="" width={200} height={200} />
                    <div className='icons_social'>
                      <Link href="#" className='footer_icons'><FaFacebook /></Link>
                      <Link href="#" className='footer_icons'><FaInstagram /></Link>
                    </div>
                    </div>
                    <div className='col-lg-4'>
                    ...
                    <div className='col-lg-4'>
                        ...
                        <div className='main_row_margin'>
                          ...
                          <FaWhatsapp color='white' size={20}/>
                            <Link href="https://wa.me/+447482020223" target="_blank">Whatsapp +447482020223</Link>
                          </div>
                        </div>
                    </div>
